...
export default function Dashboard({ auth }) {
	...
	return (
		<AuthenticatedLayout
			...
			number={<AccountNumber accountNumber={accountNumber} />}>
			<Head title="Dashboard" />

			<div className="py-2 bg-gray-100">
				<div className="flex mx-auto gap-2 sm:px-4 lg:px-6">
					<div className="flex-auto px-5 py-6 w-80 gap-4 bg-gradient-to-r from-aquaWave via-skyWater to-oceanBlue dark:bg-gray-800 overflow-hidden shadow-md sm:rounded-2xl">
						<div className="flex flex-col gap-1">
							<p className="text-white text-lg">Member Since: October 5, 2024</p>
